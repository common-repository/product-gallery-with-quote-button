=== Product Gallery with Quote Button ===
Contributors: japsis
Tags: quote, gallery, woocommerce, product, email, form, contact, ajax, multilingual, offer
...
* [WooCommerce](https://wordpress.org/plugins/woocommerce/) by Automattic - With WooCommerce you can create products to be shown in Gallery

== Installation ==

1. Upload the entire `product-gallery-with-quote-button` folder to the `/wp-content/plugins/` directory.
1. Activate the plugin through the **Plugins** screen (**Plugins > Installed Plugins**).

You will find **Gallery with Quote** menu in your WordPress admin screen.

For basic usage, add shortcode [gallery_with_quote]